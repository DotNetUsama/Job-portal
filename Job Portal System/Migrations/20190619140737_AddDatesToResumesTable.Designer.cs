...
namespace Job_Portal_System.Migrations
{
    ...
    [Migration("20190619140737_AddDatesToResumesTable")]
    partial class AddDatesToResumesTable
    {
            ...
            modelBuilder.Entity("Job_Portal_System.Models.FieldOfStudy", b =>
                {
                    ...
                    b.HasIndex("FieldOfStudySynsetId");

                    b.ToTable("FieldOfStudies");
                });

            modelBuilder.Entity("Job_Portal_System.Models.FieldOfStudySynset", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Job_Portal_System.Models.JobTitle", b =>
                {
                    ...
                    b.HasIndex("JobTitleSynsetId");

                    b.ToTable("JobTitles");
                });

            modelBuilder.Entity("Job_Portal_System.Models.JobTitleSynset", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Job_Portal_System.Models.Skill", b =>
                {
                    ...
                    b.HasIndex("SkillSynsetId");

                    b.ToTable("Skills");
                });

            modelBuilder.Entity("Job_Portal_System.Models.SkillSynset", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
